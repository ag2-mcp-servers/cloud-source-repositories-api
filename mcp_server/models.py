...
class MirrorConfig(BaseModel):
    deployKeyId: Optional[str] = Field(
        None,
    ...
    url: Optional[str] = Field(
        None, description='URL of the main repository at the other hosting service.'
    )
...
class PubsubConfig(BaseModel):
    messageFormat: Optional[MessageFormat] = Field(
        None, description='The format of the Cloud Pub/Sub messages.'
    )
...
class Repo(BaseModel):
    mirrorConfig: Optional[MirrorConfig] = Field(
        None,
    ...
    pubsubConfigs: Optional[Dict[str, PubsubConfig]] = Field(
        None,
...
class SyncRepoMetadata(BaseModel):
    ...
    startTime: Optional[str] = Field(
        None, description='The time this operation is started.'
    )
    statusMessage: Optional[str] = Field(
        None, description='The latest status message on syncing the repository.'
    )
    updateTime: Optional[str] = Field(
        None, description="The time this operation's status message is updated."
    )
...
class UpdateRepoRequest(BaseModel):
    repo: Optional[Repo] = Field(
        None, description='The new configuration for the repository.'
    )
...
class ListReposResponse(BaseModel):
    ...
    repos: Optional[List[Repo]] = Field(None, description='The listed repos.')
...
class ProjectConfig(BaseModel):
    enablePrivateKeyCheck: Optional[bool] = Field(
        None, description='Reject a Git push that contains a private key.'
    )
    name: Optional[str] = Field(
        None, description='The name of the project. Values are of the form `projects/`.'
    )
    pubsubConfigs: Optional[Dict[str, PubsubConfig]] = Field(
        None,
...
class UpdateProjectConfigRequest(BaseModel):
    projectConfig: Optional[ProjectConfig] = Field(
        None, description='The new configuration for the project.'
    )
    updateMask: Optional[str] = Field(
        None,
